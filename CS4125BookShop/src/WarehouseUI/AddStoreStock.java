...
import WarehouseControls.AddStoreStockControl;
import Orders.Book;
import java.awt.*;
...
public class AddStoreStock extends JFrame implements ActionListener {
    ...
    public AddStoreStock(String userName) {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (source.equals(jbtAddStock)) {
            AddStoreStockControl addStoreStockObject = new AddStoreStockControl();
            addStoreStockObject.addStoreStock(choice, Integer.parseInt(M.getText()));
            WarehouseMainMenu wmenu = new WarehouseMainMenu(userName);
            this.setVisible(false);
        }
    }
